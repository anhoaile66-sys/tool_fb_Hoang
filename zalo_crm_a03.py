                    ...
                    if not on_chat:
                        ...
                        if not check_ex:
                            ...
                            try:
                                ...
                                chat_list = d.xpath('//*[@resource-id="com.zing.zalo:id/btn_search_result"]').all()
        ...
        if (dict_status_zalo[num_phone_zalo] != ''):
            ...
            if check_busy:
                ...
                if type == 'image':
                    ...
                    # d.push(f'{ZALO_BASE_PATH}image.jpg', f'/sdcard/DCIM/Zalo/image{image_number}.jpg')
                    # d.push(f'{ZALO_BASE_PATH}image.jpg', f'/sdcard/Pictures/Zalo/image{image_number}.jpg')
                    eventlet.sleep(0.1)
                    image_number -= 1
    ...
    if (id_device in dict_devices and num_phone_zalo in dict_status_zalo.keys()):
        if (dict_status_zalo[num_phone_zalo] != ''):
            ...
            if check_busy:
                ...
                '''
                with open(f'{DEVICE_STATUS_PATH(dict_phone_device[num_phone_zalo])}', 'r') as f:
                    device_status = json.load(f)
                '''
                try:
                    d = u2.connect(id_device)
        ...
        for id in range(len(name_zalos)):
            ...
            if not ck_zalo:
                ...
                #    if zalo_data[it]['name'] == name_zalos[id] and zalo_data[it]['num_phone_zalo'] != "":
                   ...
                   ], "list_group": [], "list_invite_friend": [], "list_prior_chat_boxes": [], "list_unseen_chat_boxes": [], "status": True})
...
def background_get_unseen_loop():
    ...
    while True:
        ...
        on_chat = False
        # update = False
        docs = get_base_id_zalo_json(ZALO_BASE_PATH, "num_phone_zalo", f"Zalo_data_login_path_{dict_phone_device[now_phone_zalo]}", {
