...
id_port = {
    ...
    "22615833": [{"8009": "9PAM7DIFW87DOBEU"}, {"8006": "CEIN4X45I7ZHFEFU"}], #Chị Ngô Dung
    "22814414": [{"8019": "Z5LVOF4PRGXGTS9H"}, {"8002": "7DXCUKKB6DVWDAQO"}], #Chị Bích Ngọc
    "22789191": [{"8014": "F6NZ5LRKWWGACYQ8"}, {"8001": "R8YY70F5MKN"}], #Chị Lại Thị Nhàn
    "22833463": [{"8015": "QK8TEMKZMBYHPV6P"}, {"8003": "TSPNH6GYZLPJBY6X"}], #Chị Thư
    "22636101":[{"8016": "IJP78949G69DKNHM"}, {"8005": "UWJJOJLB85SO7LIZ"}], #Chị Thùy
    "22896992":[{"8013": "EY5H9DJNIVNFH6OR"}, {"8004": "7HYP4T4XTS4DXKCY"}], #Huyền Trang
    ...
    for dp in device_and_port:
        ...
        try:
            ...
            for zalo in zalo_data:
                if zalo['name'] == "" or zalo['name'] == "Thêm tài khoản" or zalo['num_phone_zalo'] == "":
                    continue
