...
def api_log_in_status(id_device):
    ...
    if os.path.exists(file_path_new):
        os.remove(file_path_new)  # Xóa file nếu có
    zalo_data = []
    ...
    docs = get_base_id_zalo_json(
        "D:/Zalo_CRM/Zalo_base", "id_device", f"Zalo_data_login_path_{id_device}", {"id_device": id_device})
    list_not_online = []
    online_zalo = ""
